...
gnuplot -e "filename='hori_17.dat'; xtitle='Size of window'; ytitle='Level'; toptitle='horizontal 17'; name1='Average level'; name2='Maximum level'; name3='Minimum level'; name4='amount of tens'" plot16789.pg > level_hori_17.png

gnuplot -e "filename='hori_18.dat'; xtitle='Size of window'; ytitle='Level'; toptitle='horizontal 18'; name1='Average level'; name2='Maximum level'; name3='Minimum level'; name4='amount of tens'" plot16789.pg > level_hori_18.png

gnuplot -e "filename='vert_17.dat'; xtitle='Size of window'; ytitle='Level'; toptitle='vertical 17'; name1='Average level'; name2='Maximum level'; name3='Minimum level'; name4='amount of tens'" plot16789.pg > level_vert_17.png

gnuplot -e "filename='vert_18.dat'; xtitle='Size of window'; ytitle='Level'; toptitle='vertical 18'; name1='Average level'; name2='Maximum level'; name3='Minimum level'; name4='amount of tens'" plot16789.pg > level_vert_18.png
