...
The main focus of this thesis is to introduce the SRS \todo{Kan man give den et bedre navn?} data structure. It is a simplification of the work done by \citet{chanetal}.
