...
\begin{enumerate} 
  ...
  \item Finally the region of a node and the search query have nothing in common in which case the search at that node stops. This check will be done by the parent of the node before recursing into the node. \todo{Forklar bedre - skal det ændres længere oppe? Det er jo semantisk set det samme}
\end{enumerate}
