...
In this chapter a simplification of the work done by \citet{chanetal} is presented followed by their original idea. The simplification is the primary work of this thesis. The order in which it is presented is chosen so the read can better get acquinted with the core concepts before reading about the original work of \citet{chanetal}. The theory behind a $kD$-tree will also be explained as it is the de facto standard of orthogonal range queries today and will be used to compare the practical results of the simplified model. \todo{rewrite}
