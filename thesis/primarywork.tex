...
\subsubsection{Succinct rank queries}
...
In order to look up the rank space predecessor of a given coordinate, another succinct data structure will be used. This data structure has a worse space complexity than the RMQ and a bigger query time.
