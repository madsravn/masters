...
The sections will start with a \emph{preliminaries} subsection. This subsection will describe some of the auxiliary data structures used in the section. As in \ref{ch:relatedwork} the main data structures mentioned in this chapter are output-sensitive.
